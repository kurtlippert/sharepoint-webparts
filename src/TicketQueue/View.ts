...
import { Action, statusFilter, titleSearch, toggleStatusFilter, toggleTitlesSearch } from './Actions'
import { Ticket, TicketQueue } from './Model'
      ...
      columns: [
        ...
        } as ColumnExtended,
        {
          ...
          name:
            ...
            ? r(Dropdown as React.ComponentClass<any>, {
...
const _TicketQueue: any = connect<StateProps, DispatchProps, void, State>(
  mapStateToTicketQueueProps,
  mapDispatchToTicketQueueProps,
)(ticketQueue)

export default _TicketQueue
